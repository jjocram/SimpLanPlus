...
\begin{enumerate}
    ...
    %\item Premere il pulsante ``Play'' di Eclipse. Verrà mostrato un prompt nel quale va inserito il path al file \verb|.simplan| scritto al punto precedente. \`E possibile utilizzare uno dei file forniti nella cartella \verb|examples| scrivendo nel prompt \verb|examples/example1.simplan|.
