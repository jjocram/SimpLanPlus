...
public class SVMParser extends Parser {
    ...
    public static class NotBoolContext extends InstructionContext {
        ...
        public TerminalNode BOOL() {
            return getToken(SVMParser.BOOL, 0);
        }
        ...
        public NotBoolContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class MultIntContext extends InstructionContext {
        ...
        public MultIntContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BranchContext extends InstructionContext {
        ...
        public BranchContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class DeleteContext extends InstructionContext {
        ...
        public DeleteContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class StoreWordContext extends InstructionContext {
        ...
        public StoreWordContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LoadWordContext extends InstructionContext {
        ...
        public LoadWordContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class SubIntContext extends InstructionContext {
        ...
        public SubIntContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class JumpToFunctionContext extends InstructionContext {
        ...
        public JumpToFunctionContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LoadIntegerContext extends InstructionContext {
        ...
        public LoadIntegerContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class JumpToRegisterContext extends InstructionContext {
        ...
        public JumpToRegisterContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class AndBoolContext extends InstructionContext {
        ...
        public AndBoolContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BranchIfLessEqualContext extends InstructionContext {
        ...
        public BranchIfLessEqualContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BranchIfEqualContext extends InstructionContext {
        ...
        public BranchIfEqualContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class AddIntContext extends InstructionContext {
        ...
        public AddIntContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class DivIntContext extends InstructionContext {
        ...
        public DivIntContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class OrBoolContext extends InstructionContext {
        ...
        public OrBoolContext(InstructionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static final String _serializedATN =
            "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3(o\4\2\t\2\4\3\t\3" +
                    ...
                    "!\2\2Zm\7#\2\2[\\\7\32\2\2\\]\7!\2\2]^\7!\2\2^m\7#\2\2_`\7\33\2\2`m\7" +
                    "#\2\2ab\7#\2\2bm\7\"\2\2cd\7\34\2\2dm\7#\2\2ef\7\35\2\2fm\7!\2\2gh\7\36" +
                    "\2\2hm\7!\2\2ij\7\37\2\2jm\7!\2\2km\7 \2\2l\f\3\2\2\2l\16\3\2\2\2l\17" +
                    "\3\2\2\2l\25\3\2\2\2l\33\3\2\2\2l\36\3\2\2\2l\"\3\2\2\2l&\3\2\2\2l*\3" +
                    "\2\2\2l.\3\2\2\2l\62\3\2\2\2l\66\3\2\2\2l:\3\2\2\2l>\3\2\2\2lB\3\2\2\2" +
                    "lF\3\2\2\2lI\3\2\2\2lM\3\2\2\2lQ\3\2\2\2lT\3\2\2\2lW\3\2\2\2l[\3\2\2\2" +
                    "l_\3\2\2\2la\3\2\2\2lc\3\2\2\2le\3\2\2\2lg\3\2\2\2li\3\2\2\2lk\3\2\2\2" +
                    "m\5\3\2\2\2\4\tl";
